...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/04/17 11:25:12 by vafernan          #+#    #+#             */
/*   Updated: 2025/04/21 18:54:47 by vafernan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Fixed::Fixed(const int input)
{
	...
	this->_fp_value = input * _scale;
}

Fixed::Fixed(const float input)
{
	// std::cout << "Fixed Float Constructor called" << std::endl;
	this->_fp_value = roundf(input * _scale);
}
