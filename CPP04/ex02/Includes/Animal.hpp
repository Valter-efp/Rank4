...
/*   Updated: 2025/04/28 10:41:56 by vafernan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class Animal
{
	...
	public:
		...
		virtual void makeSound() const = 0;	//Now makeSound is pure virtual, which ,eams the child will have to use their own
